...
- `APP__EXTERNAL_BASE_URL` — public frontend URL used to build Prolific study links (default: `http://localhost:5173`)
...
- `APP__EXTERNAL_BASE_URL` — public frontend URL, e.g. `https://human-rating-platform-web.onrender.com`
