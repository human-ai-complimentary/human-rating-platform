...
from models import Experiment, Question, StudyRound
from schemas import (
    PilotStudyCreate,
...
async def _create_prolific_study_for_experiment(
    ...
    *,
    ...
    external_study_url = (
        f"{app_settings.app.external_base_url}/rate"
...
async def run_pilot_study(
    ...
    experiment.prolific_study_status = result.get("status", "UNPUBLISHED")
    ...
    round_ = StudyRound(
        ...
        prolific_study_status=result.get("status", "UNPUBLISHED"),
