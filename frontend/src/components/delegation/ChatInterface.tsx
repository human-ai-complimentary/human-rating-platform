...
export function ChatInterface({ task, pid, experimentId, onComplete }: ChatInterfaceProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const data = await api.sendChatMessage(pid, task.id, experimentId, updatedMessages);
    ...
    return (
      <div className="p-6">
        <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
          <h2 className="text-lg font-semibold text-green-900 mb-2">Session Complete</h2>
